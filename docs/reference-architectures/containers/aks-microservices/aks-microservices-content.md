...
- **Monitor vulnerabilities.** Continuously monitor images and running containers for known vulnerabilities by using [Microsoft Defender for Cloud](/azure/defender-for-cloud/defender-for-containers-introduction) or a non-Microsoft solution.
