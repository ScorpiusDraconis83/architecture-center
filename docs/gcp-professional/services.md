...
| | [Cloud Load Balancing](https://cloud.google.com/load-balancing) | [Azure Front Door](/azure/frontdoor/front-door-overview) | Azure Front Door enables global load balancing across regions. Unlike Cloud Load Balancing, which uses a single anycast IP, Azure Front Door uses unicast IPs to route traffic to an optimal point of presence. |
