...
- *AI* technologies solve problems that are computationally complex to implement in traditional application code. For more information, see [Choose a Foundry Tools technology](../data-guide/technology-choices/ai-services.md).
