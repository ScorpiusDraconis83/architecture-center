...
- A front-end service like Azure Front Door that does dynamic content acceleration and [Split TCP](/azure/frontdoor/front-door-traffic-acceleration#connect-to-the-front-door-edge-location-split-tcp).
