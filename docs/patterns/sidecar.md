...
The application performs core functionality and the sidecar performs peripheral tasks, like platform abstraction, proxy to remote services, logging, and configuration. Both the application and sidecar reside in a host.
:::image-end:::
